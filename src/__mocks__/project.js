      ...
      activities: [
        {
          ...
          description: 'has uploaded a new file again',
...
mock
  .onGet('/api/projects/projects/2')
  .reply(() => {
    const project = {
      id: '5e8dcf076c50b9d8e756a5a3',
      activities: [
        {
          id: '5e8dd0828d628e6f40abdfe9',
          createdAt: subMinutes(now, 19).getTime(),
      ...
      activities: [
        {
          id: '5e8dd0828d628e6f40abdfe9',
          createdAt: subMinutes(now, 19).getTime(),
          description: 'This is a channel activity',
          subject: 'Project author',
          type: 'upload_file'
        },
        {
