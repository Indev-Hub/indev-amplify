    ...
    items: [
      ...
      },
      {
        ...
        children: [
          {
            title: 'Browse',
            path: '/dashboard/channels/browse'
          },
          {
            title: 'Details',
            path: '/dashboard/channels/1'
          },
          {
            title: 'Create',
            path: '/dashboard/channels/new'
          }
        ]
      },
      {
...
DashboardSidebarDeveloper.propTypes = {
  onMobileClose: PropTypes.func,
  openMobile: PropTypes.bool
};

export default DashboardSidebarDeveloper;
