...
const ChannelApplicationModal = (props) => {
    ...
    >
      <Box sx={{ p: 3 }}>
        <Typography
          ...
          variant="h4"
        >
          The channel requires an introduction
        </Typography>
        <Typography
          align="center"
          color="textSecondary"
        ...
        <Box sx={{ mt: 3 }}>
          <TextField
            ...
            placeholder="What excites you about this channel?"
            rows={5}
            value={value}
            variant="outlined"
          />
...
ChannelApplicationModal.propTypes = {
...
export default ChannelApplicationModal;
