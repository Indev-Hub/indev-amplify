...
import VideoLibraryCardModal from './VideoLibraryCardModal';

const cardSelector = (state, cardId) => {
  const { cards, members } = state.videoLibrary;
...
const VideoLibraryCard = forwardRef((props, ref) => {
