...
const VideoLibraryCheckItemRoot = experimentalStyled('div')(({ theme }) => ({
...
const VideoLibraryCheckItem = (props) => {
  const {
    cardId,
    checkItem,
    checklistId,
  ...
  return (
    <VideoLibraryCheckItemRoot {...other}>
      <Checkbox
    ...
    </VideoLibraryCheckItemRoot>
  );
};

VideoLibraryCheckItem.propTypes = {
...
VideoLibraryCheckItem.defaultProps = {
  editing: false
};

export default VideoLibraryCheckItem;
