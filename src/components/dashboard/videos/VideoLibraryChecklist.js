...
import VideoLibraryCheckItem from './VideoLibraryCheckItem';
import VideoLibraryCheckItemAdd from './VideoLibraryCheckItemAdd';

const VideoLibraryChecklistRoot = experimentalStyled('div')();

const VideoLibraryChecklist = (props) => {
  ...
  return (
    <VideoLibraryChecklistRoot {...other}>
      <Box
        sx={{
          alignItems: 'center',
          display: 'flex'
      ...
      >
        <VideoLibraryCheckItemAdd
          cardId={card.id}
          checklistId={checklist.id}
        />
      </Box>
    </VideoLibraryChecklistRoot>
  );
};

VideoLibraryChecklist.propTypes = {
  // @ts-ignore
...
export default VideoLibraryChecklist;
