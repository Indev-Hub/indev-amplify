...
import VideoLibraryCardAdd from './VideoLibraryCardAdd';
...
const VideoLibraryColumn = (props) => {
  ...
  return (
    <div {...other}>
      ...
      >
        ...
        <Divider />
        <Box sx={{ p: 2 }}>
          <VideoLibraryCardAdd columnId={column.id} />
        </Box>
        <Menu
...
VideoLibraryColumn.propTypes = {
  columnId: PropTypes.string.isRequired
};

export default VideoLibraryColumn;
