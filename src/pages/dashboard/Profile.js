...
import { ProfileConnections, ProfileTimeline } from '../../components/dashboard/profile';
...
const Profile = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Dashboard:  Profile | Material Kit Pro</title>
      </Helmet>
      <Box
        sx={{
        ...
        <Box sx={{ mt: 3 }}>
          <Container maxWidth="lg">
            ...
            <Box sx={{ py: 3 }}>
              ...
              {currentTab === 'connections' && <ProfileConnections />}
            </Box>
          </Container>
        </Box>
      </Box>
